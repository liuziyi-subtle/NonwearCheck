...
if __name__ == '__main__':
    '''
    usage:
    python3 aggregate_annotations.py --json_dir /Users/liuziyi/Documents/Lifesense/data/nonwear-check/O/results/jsons \
                                     --record_field record \
                                     --segment_field segment \
                                     --value_description_path /Users/liuziyi/Documents/Lifesense/data/nonwear-check/O/raw/value_descriptions.json \
                                     --save_path /Users/liuziyi/Documents/Lifesense/data/nonwear-check/O/results/annotations.json
